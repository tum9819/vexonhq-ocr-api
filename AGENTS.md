...
*Last updated: Session 49, 2026-05-31 (pitfalls #26-33 — full-system audit: RLS anon-key breach, storage bucket, false-healthy cron, webhook fail-closed, pos_sales_items dedup, bank-upload to_thread, AI-JSON shape, date-param 500s).*
